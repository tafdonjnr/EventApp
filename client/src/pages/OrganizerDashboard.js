    ...
    <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 sm:px-6">
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div className="flex items-center gap-4">
          {logo && (
            <img src={logo} alt="Logo" className="h-12 sm:h-14 rounded-xl object-cover" />
          )}
          <h1 className="heading-1">{orgName}</h1>
        </div>
      ...
      <h2 className="heading-2 mb-8">Welcome back, {orgName}!</h2>

      {error && (
        <div className="card-standard mb-6 text-red-600 border-red-200 bg-red-50">
          {error}
        </div>
      )}
      {message && (
        <div className="card-standard mb-6 text-green-700 border-green-200 bg-green-50">
          {message}
        </div>
      )}
      ...
      <hr className="border-softBorder my-8" />
